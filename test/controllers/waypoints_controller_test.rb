...
class WaypointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waypoint" do
    assert_difference('Waypoint.count') do
      post waypoints_url, params: { waypoint: { route_id: @waypoint.route_id, x: @waypoint.x, y: @waypoint.y } }
    end
  ...
  test "should update waypoint" do
    patch waypoint_url(@waypoint), params: { waypoint: { route_id: @waypoint.route_id, x: @waypoint.x, y: @waypoint.y } }
